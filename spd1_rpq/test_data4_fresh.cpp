   ...
   //     int *order = new int[n], *temp = new int[n], *temp2 = new int[n], cmax=0, t=0;
     ...
     //               cout << "\nCmax = " << cmax << endl << endl;
      ...
      /*      for(int i = 0; i < n; i++)
            ...
            int modifiedorder[] = {37, 19, 45, 17, 20, 21, 41, 25, 29, 12, 8, 7, 23, 24, 15, 43, 6, 48, 27, 10, 32, 46 , 16, 26, 28, 31,
                                    36, 2, 4, 42, 13, 47, 30, 18, 34, 33, 39, 14, 5, 40, 44, 22, 35, 3, 9, 1, 11, 38};
            ...
            cout << filename[3] << endl << "Kolejnosc optymalna: ";
                    for(int z=0; z<n; z++){
            ...
            cout << "xR-yQ:  (Cmax = " << best << ")\t\t";
            cout << "po R:  (Cmax = " << "39616" << ")\t\t";
            cout << "po Q:  (Cmax = " << "39303" << ")\n";
